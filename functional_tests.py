...
class VisitorTest(unittest.TestCase):
    ...
    def test_things_list(self):
        ...
        input_box = self.browser.find_element_by_name('things')
        input_box.send_keys(u"购买《Python核心编程》")
        submit_btn = self.browser.find_element_by_id('submit_btn')
        self.assertEqual(str(type(submit_btn)), "<class 'selenium.webdriver.firefox.webelement.FirefoxWebElement'>")
        submit_btn.click()
